        ...
        <div id="wrapper">
            ...
            <div class="content-page-improved">
                ...
                <div class="content" style="text-align:center;">
                    <div class="container card-box-improved">
          ...
          $("#sendchat").click( function() {
              ...
              // send
                ...
                <h4 class="text-center">Chat</h4>
                    <div class=" userarea" style="height:78%; padding: 0 5%;">
                          <div id="chat-wrap">
                ...
                if(!isset($_SESSION["steamid"])){
                  ...
                  echo '
                    ...
                    <div id="otpsoob"><form id="send-message-area">
                      <textarea id="sendie" maxlength="125" s="2" placeholder="Enter your message"></textarea>
