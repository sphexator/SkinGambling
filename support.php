                	...
                	<div class="col-md-12 col-lg-12">
                        <div class="widget-bg-color-icon card-box">
							<p style="font-size:20px;">
								Questions and Inquires can be sent to: support@skinz4u.com
							</p>
							<h3>Teamspeak 3</h3>
							<button type="button" class="btn btn-primary waves-effect waves-light"><a href="ts3server://skinz4u.com/?port=10323">Connect to Server</a></button>
							<br>
                        </div>
                    </div>
                </div> <!-- container -->
